...
describe('Payment Routes', () => {
  describe('POST /api/orders/create', () => {
    it('creates an order with free payment (invoice)', async () => {
      ...
      await env.DB.prepare("INSERT OR IGNORE INTO gutscheine (id, code, discount_type, discount_value, max_uses, total_uses, is_active) VALUES ('promo-free', 'FREE100', 'percent', 100, 50, 0, 1)").run()
